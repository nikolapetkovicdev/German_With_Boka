...
('user-admin', 'admin@germanwithboka.local', '$2b$12$R/QcaffuEoamLv1EZDDEJOkHDencMI10yVIBH.Aa3S5kS.uxoCScq', 'ADMIN', true, now(), now()),
('user-teacher', 'teacher@germanwithboka.local', '$2b$12$R/QcaffuEoamLv1EZDDEJOkHDencMI10yVIBH.Aa3S5kS.uxoCScq', 'TEACHER', true, now(), now()),
('user-parent', 'parent@germanwithboka.local', '$2b$12$R/QcaffuEoamLv1EZDDEJOkHDencMI10yVIBH.Aa3S5kS.uxoCScq', 'PARENT', true, now(), now()),
('user-student', 'student@germanwithboka.local', '$2b$12$R/QcaffuEoamLv1EZDDEJOkHDencMI10yVIBH.Aa3S5kS.uxoCScq', 'STUDENT', true, now(), now())
